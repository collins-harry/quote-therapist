...
psychobabble = [
    ...
    [r'It is (.*)',
     ["You seem very certain. Are you sure?",
    ...
    [r'Can I ([^\?]*)\?',
     ["Perhaps you don't want to {0}. Do you?",
    ...
    [r'Is there (.*)',
     ["Do you think there is {0}?",
      "It's likely that there is {0}. Does that interest you?",
    ...
    [r'Is it (.*)',
     ["Do you think it is {1}?",
      ...
      "It could well be that {1}. Do you agree?"]],
    ...
    [r'(.*) Is there (.*)',
     ["Do you think there is {1}?",
      "It's likely that there is {1}. Does that interest you?",
